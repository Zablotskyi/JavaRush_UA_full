...
public class Solution {
    ...
    public static Stream<Language> sortByRanking(ArrayList<Language> languages) {
        ...
        Stream<Language> stream = languages.stream().sorted(Comparator.comparing(Language::getRanking));
        List<Language> list = stream.collect(Collectors.toList());
        Collections.reverse(list);
        Stream<Language> resultStream = list.stream();
