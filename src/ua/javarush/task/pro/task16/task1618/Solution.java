...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        ...
        ZonedDateTime originalZonedDateTime = ZonedDateTime.of(fromDateTime, fromZone);
        ZonedDateTime newZonedDateTime = originalZonedDateTime.withZoneSameInstant(toZone);
